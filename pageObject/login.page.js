export class Login {
    constructor(page) {
        this.page = page;
        this.url = 'https://dev-app.creativelysquared.com/';
        ...
        this.passwordLabelLocator = page.locator("xpath=//input[@name='email']/following-sibling::label");
        ...
        this.resetPasswordButton = page.locator('button', { name: 'Reset password' });
        this.loginNowButton = page.locator('button', { name: 'Login now' });
